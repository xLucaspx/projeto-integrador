...
public class Produto {
	...
	private void setPrecoCusto(float precoCusto) {
		if (precoCusto <= 0) throw new ValidationException("O preço inserido é inválido; por favor, insira um valor maior do que 0!");
		if (precoCusto >= precoVenda) throw new ValidationException("O preço de custo deve ser menor do que o preço de venda!");
	...
	private void setQuantidade(double quantidade) {
		if (quantidade <= 0) throw new ValidationException("A quantidade inserida é inválida; por favor, insira um valor maior do que 0!");
	...
	private void setImposto(float imposto) {
		if (imposto < 0) throw new ValidationException("O imposto inserido é inválido; por favor, insira um valor maior ou igual a 0!");
	...
	private void setPrecoVenda(float precoVenda) {
		if (precoVenda <= 0) throw new ValidationException("O preço de venda inserido é inválido; por favor, insira um valor maior do que 0!");
		if (precoVenda <= precoCusto) throw new ValidationException("O preço de venda não pode ser menor do que o preço de custo!");
