...
public class App {
	public static void main(String... args) {
		...
		Fornecedor f1 = new Fornecedor("14.167.876/0001-47", "Aqui o Nome Fantasia", "empresa@email.com", "(51) 99876-5543",
				e2);
		Fornecedor f2 = new Fornecedor("14167876000147", "Aqui NF", "fulano@dominio.sub.com.br", "5133456788", e2);
		f2.setNome("editado");
